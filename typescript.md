...
type Controller<ReqParams = any, ResBody = any, ReqBody = any, ReqQuery = any> = (
...
const registerController: Controller<{}, RegisterResponseBody, RegisterRequestBody> = async (req, res) => {
